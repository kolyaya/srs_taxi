    ...
    DESC: При нажатии на вкладку “Заказы” отображается страница со свободными заказами, вложенной вкладкой переключения на зарезервированные заказы и картой.
      ...
      \begin{itemize}
        ...
        \item{
          ...
          \sr{Элементы этого окна описаны в таблице \ref{driver_app_orders_tab_table}.}\\
          PRIOR: MODERATE\\}
      ...
      \subsubsection{Карточка “Заказ”}  \label{orders_tab_element_order_description}
          ...
          \begin{itemize}
              ...
              \item{
                ...
                \sr{Если водитель принимает заказ от Яндекс.Такси, то при ожидании подтверждения от сервера назначения водителя на заказ на карточку выбранного заказа накладывается прелоадер (gif-анимация ожидания).}\\
                PRIOR: MODERATE\\}
