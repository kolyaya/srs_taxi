    ...
    \subsubsection{Вкладка при первом открытии} \label{driver_app_taximeter_tab_first_opening}
      \begin{itemize}
        ...
        \item{
          ...
          \sr{Во вкладке при первом открытии должны присутствовать элементы, которые перечислены и описаны описаны в таблице \ref{driver_app_taximeter_tab_first_opening_elements}.}\\
          PRIOR: MODERATE\\}
